...
writeHeader:
		...
		@ put P in buffer
		mov	r3, #'P'	@ put P in scratch register(r3)
		strb	r3, [r4, r5]	@ put r3(P) in buffer
		add	r5, r5, #1	@ increment buffer length
		
		@put 3 in buffer
		mov	r3, #3		@ put 3 in scratch register(r3)
		strb	r3, [r4, r5]	@ put r3(3) in buffer
		add	r5, r5, #1	@ increment buffer length
		...
		mov	r3, #' '	@ don't know if ' ' will work, ascii code is 32
		strb	r3, [p4, p5]
		add	r5, r5, #1
		...
		mov	r3, #2		@ put 2 in scratch register(r3)
		strb	r3, [r4, r5]	@ put r3(2) in buffer
		add	r5, r5, #1	@ increment buffer length
		
		mov	r3, #3		@ put 5 in scratch register(r3)
		strb	r3, [r4, r5]	@ put r3(5) in buffer
		add	r5, r5, #1	@ increment buffer length
